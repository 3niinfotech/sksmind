...
<html>
	...
	<body>
		<?php
			...
			?>
			<?php
				$cat_count_rs = mysql_query("select * from user where user_id = ".$_GET['id']);
				$cat_count_list =  mysql_fetch_assoc($cat_count_rs);	
				$_SESSION['temp_edit_user']	= $_GET['id'];			
			?>
				...
				<?php
					...
					?>	
					<div class = "template_heading account_heading"><span class = "template_left">Edit User Account Information</span><span class="template_right" style = "margin: 0 10px;"><a class="button round blue" href="<?php echo $_SERVER['HTTP_REFERER']; ?>">Back</a></span>  </div> 
<form method="post" action="login/user-info.php">
					<div class = "main">
						<div class = "account_info_div">
							...
							<div class = "customer_drid">
								<label class="required" for="firstname">Full Name</label>
								<div class = "cat_detail_lable_input">
							...
							<div class = "customer_drid">
								...
								<div class = "cat_detail_lable_input">
									<input type="text" name="mobile" id = "mobile" placeholder="Mobile"  value="<?php echo $cat_count_list['mobile']; ?>" maxlength="10">
							...
							<div class = "customer_drid">
								...
								<div class = "cat_detail_lable_input">
									<textarea name="address" id = "address" placeholder="Company Address" ><?php echo $cat_count_list['address']; ?></textarea>
								</div>
							</div>	
							<div class = "customer_drid">
