					...
					<div class = "main mail_email">
						<div class = "main_left customer_list">
								<div class = "container_view">
									...
									<div class = "section_contant">
										<div class = "section_contant_sub content_open">
											<a class = "open_view_a" href = "view-track-report.php?id=<?php echo $email_record_id; ?>"><p><?php echo $num_rows; ?></p>
											<p>Opened</p></a>
										</div>
										<div class = "section_contant_sub content_bounce">
											<a class = "bounce_view_a"><p><?php echo $num_bounce; ?></p>
											<p>Bounced</p></a>
										</div>
									</div>		
								</div>
								<?php
									...
									$bounce_id = 1;
									$bounce_grid = array();
									while ($trck_bounce_list =  mysql_fetch_assoc($trck_bounce_co))
									{
										
										$bounce_email_id = $trck_bounce_list['id']; 
										$bounce_email = $trck_bounce_list['email']; 
										$bounce_name = $trck_bounce_list['name']; 
										$bounce_date = date("d F Y H:i:s", strtotime($trck_bounce_list['date'])); 
										
										$c_last_li_html = "";
										
										$c_last_li_html = '<a href = "edit-email.php?id='.$bounce_email_id.'"><span class="fa fa-pencil-square-o"></span></a>';
										
										$bounce_grid[] = array('id' => "$bounce_id" ,'email_id' => "$bounce_email",'c_name' => "$bounce_name",'last_read' => "$bounce_date",'last_li' => "$c_last_li_html");
										$index++; 
										$bounce_id++;
									}
									
									$bounce_grid_json = json_encode($bounce_grid);
									
								?>
									
								<div class="container_outer">
									<div class="container class_container_outer_relative">
										<h2 class = "page_sub_title">Bounced Email</h2>
								...
								<script>
									jQuery(function(jQuery){
										jQuery('.table').footable({
											...
											"columns": jQuery.get("customer/bounce_record_columns.json"),
											"rows": <?php echo $bounce_grid_json; ?>
										});
									});
								</script>
