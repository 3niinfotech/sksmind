		...
		<?php
			...
			if (isset($_SESSION['login_user']))
			{
				...
				{     
					...
					$sql1="SELECT * FROM catalog WHERE cat_name ='$new_catname'";
					...
					if($count==0)
					{
							...
							$sql = "UPDATE catalog SET cat_name ='$new_catname' WHERE id = ".$cat_id;
							if (mysql_query($sql)) {
								//session_start();
						...
						unset($_SESSION['su_cat']); 
						session_start();
						$_SESSION['error_cat']= "Category Name Already exist";
						 echo "<script type='text/javascript'> document.location = 'category.php'; </script>";  
					}		
				}
				else{
