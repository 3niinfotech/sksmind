	...
	$error = 1;
				...
				if($count==1)
				{
					...
					{	
						...
						if (mysql_query($sql)) {
							...
							session_start();
							$_SESSION['su_cat']= "Password Successfully saved.";
		...
		else
		{
			...
			if($error==1)
			{
				...
				$sql = "UPDATE user SET user_name='$user_f_name',user_email ='$user_email',first_name='$fn', mobile='$mobile', address='$address',company_name='$company_name',tel_no='$tel_no',fax_no='$fax_no',rapnet_id='$rapnet_id',skype_id='$skype_id',wechat_id='$wechat_id',qq_id='$qq_id',welcommess='$welcommess',formality='$formality' WHERE user_id = ".$user_id;
