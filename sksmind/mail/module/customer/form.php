...
//$model  = new model();
?>
<form class="form-horizontal" method="POST" role="form" action="<?php echo $emsUrl.'module/customer/customerController.php'?>">
...
<div class="col-xs-12 col-sm-6 ">
	...
	<h4 class="widget-title">Customer Detail</h4>
