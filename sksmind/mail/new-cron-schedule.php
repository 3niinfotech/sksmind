		...
		<?php
			...
			?>
				...
				<div class = "main_container">
					...
					?>
					<div class = "template_heading"><span class="template_left">Add New Schedule</span><span class="template_right"><span class="template_right" style = "margin: 0 10px;"><a class="button round blue" href="cron-schedule.php">Back</a></span></div> 
					<div class = "main">
						
						<div class = "template_title"><h2><?php echo $template_title ?></h2></div>
						<div class = "send_mail_outer">
						 <form id="sendemail" method="POST" action = "cron/add-cron-schedule.php">   
						 	<div class = "company_info_detail_input">
										...
										<ul class = "select_tmp">
											...
											<li>	
												<div id="datetimepicker1" class="input-append date">
													<input data-format="dd/MM/yyyy hh:mm:ss" type="text" name = "send_date" id = "send_date"></input>
													<span class="add-on">
								...
								<div class = "class_country_cat">
									...
									<div class = "submit_button_div">
										<button class = "submit_button" type="button">Add Schedule</button>
									</div>	
						 </form>   
						</div>
					</div>
