		...
		<?php
			...
			<div class = "main_container">
				<?php
					...
					?>	
				<div class = "main">						
					 <form id="sendemail" method="POST" action = "change-catname.php">   
							<div class = "company_info_detail_input"/>
							<?php 
								$sql="SELECT * FROM catalog WHERE id= ".$cat_id;
								$result=mysql_query($sql);
								$row=mysql_fetch_array($result); 
								
							 ?>
								<p>Current Category Name : <?php echo $row['cat_name']?> </p> 
								<lable>Enter New Category name : </lable>									
