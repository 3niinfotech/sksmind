            ...
            <td style="width: 50%;text-align:left;;">
				...
				<table style="width: 100%;">
					<tr >
						...
						<td style="width:75%;">S.K.S.M (HK) Ltd.</td>
					</tr>
					<tr>
...
<page style="font-size: 12pt">
	...
	<hr style="width:100%;height:1px;color:#1b2c60">
	<p  style="width:100%;padding:0px;margin:0px;padding-top:2px; font-size: 11px;text-align:Center"><b style="color:#1b2c60;font-size: 13px;"> INVOICE </b>[Customer Copy]  </p>
	<hr style="width:100%;height:1px;color:#1b2c60">
    <br>
	<table cellspacing="0" style="width: 100%; text-align: left; font-size: 14px">
        <tr>
