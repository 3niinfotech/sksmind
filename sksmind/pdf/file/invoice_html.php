...
<page style="font-size: 12pt">
    <bookmark title="SHREEHK" level="0" ></bookmark>
	...
	<p  style="width:100%;padding:0px;margin:0px;padding-top:2px; font-size: 11px;text-align:Center"><b style="color:#1b2c60;font-size: 13px;"> <?php if($data['type'] =='sale'): ?>  INVOICE <?php else: ?> CONSIGNMENT <?php endif; ?></b>[Original Copy]  </p>
	<hr style="width:100%;height:1px;color:#1b2c60">
    <br>
	<table cellspacing="0" style="width: 100%; text-align: left; font-size: 14px">
        <tr>
		   ...
		   <td style="width: 30%;text-align:left;">				
				...
				<p style="font-size: 16px;margin: 0 0 2px;color:#1b2c60"><?php if($data['type'] =='sale'): ?>  Invoice <?php else: ?> Consignment <?php endif; ?> No. &nbsp;&nbsp;&nbsp;<b style="color:#1b2c60;"><?php echo $data['invoiceno'];?></b></p>
	...
	<table cellspacing="0" border="1"  cellpadding="5" style="border-color:#fff;width: 100%;   border-collapse:collapse;text-align: center; font-size: 10pt;">
<?php
     $nb = 15;
...
<page style="font-size: 12pt">
	...
	<hr style="width:100%;height:1px;color:#1b2c60">
	<p  style="width:100%;padding:0px;margin:0px;padding-top:2px; font-size: 11px;text-align:Center"><b style="color:#1b2c60;font-size: 13px;"> <?php if($data['type'] =='sale'): ?>  INVOICE <?php else: ?> CONSIGNMENT <?php endif; ?></b>[Customer Copy]  </p>
	<hr style="width:100%;height:1px;color:#1b2c60">
    <br>
	<table cellspacing="0" style="width: 100%; text-align: left; font-size: 14px">
        <tr>
        ...
        <tr>
            <td style="width: 50%;text-align:left;;">
				...
				<table style="width: 100%;">
					...
					<tr>
						<td style="width:25%;color:#1b2c60;">Account No</td>
						<td style="width:75%;">470544996 (USD)<br/> 471560588 (HKD)
						</td>
					</tr>
					<tr>
						<td style="width:25%;color:#1b2c60;">Bank Code</td>
