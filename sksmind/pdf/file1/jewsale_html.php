    ...
    <br><br>
     ...
     <table cellspacing="0" border="1" cellpadding="5" style="border-collapse:collapse;width: 100%; border: solid 1px black; color: #ce2334; text-align: center; font-size: 10pt;">
        <tr>
            ...
            <th style="width: 20%;text-align: center;padding:4px;">SKU</th>
            <th style="width: 15%;text-align: center;padding:4px;">Type</th>
            <th style="width: 18%;text-align: center;padding:4px;">Design</th>
            <th style="width: 12%;text-align: center;padding:4px;">Gold</th>
            <th style="width: 15%;text-align: center;padding:4px;">Weight</th>
			<th style="width: 15%;text-align: center;padding:4px;">Amount(US$)</th>
        </tr>
    </table>
	 <table cellspacing="0" border="1"  cellpadding="5" style="width: 100%;   border-collapse:collapse;text-align: center; font-size: 10pt;">
<?php
    $nb = 15;
	$pcs = $carat = $gram = $gross = $amount = 0;
	$record = $data['record'];
	...
	?>
		<tr>
            ...
            <td style="border-bottom:0px;width: 20%; text-align: left;padding:4px;"><?php echo $sku; ?></td>
            <td style="border-bottom:0px;width: 15%; text-align: left;padding:4px;"><?php echo ucfirst($record[$i]['jew_type']) ?></td>
            <td style="border-bottom:0px;width: 18%; text-align: left;padding:4px;"><?php echo $design[$record[$i]['jew_design']] ?></td>
            <td style="border-bottom:0px;width: 12%; text-align: left;padding:4px;"><?php echo $record[$i]['gold_type'] ?></td>            
			<td style="border-bottom:0px;width: 15%; text-align: right;padding:4px;"><?php echo number_format($record[$i]['gross_cts'] , 2, '.', ','); ?></td>
            <td style="border-bottom:0px;width: 15%; text-align: right;padding:4px;"><?php echo number_format($record[$i]['final_cost'], 2, '.', ','); ?> </td>
        </tr>
		<?php 
		...
		$amount += $record[$i]['final_cost'];
			...
			<tr>
				<td style="border-bottom:0px;width: 5%; text-align: center;padding:4px;"> &nbsp;<?php //echo $i; ?></td>
				<td style="border-bottom:0px;width: 20%; text-align: left;padding:4px;"></td>
				<td style="border-bottom:0px;width: 15%; text-align: left;padding:4px;"></td>
				<td style="border-bottom:0px;width: 18%; text-align: left;padding:4px;"></td>				
				<td style="border-bottom:0px;width: 12%; text-align: left;padding:4px;"></td>				
...
?>
    ...
    <table cellspacing="0" border="1" cellpadding="5" style="border-collapse:collapse;width: 100%; border: solid 1px black; color: #4991b1; text-align: center; font-size: 10pt;">
        <tr>
            ...
            <th style="width: 20%; text-align: left;padding:4px;"></th>
            <th style="width: 15%; text-align: left;padding:4px;"></th>
            <th style="width: 18%; text-align: left;padding:4px;"></th>
            <th style="width: 12%; text-align: left;padding:4px;"></th>            
			<th style="width: 15%; text-align: right;padding:4px;"><?php echo number_format($gross, 2, '.', ','); ?></th>
            <th style="width: 15%; text-align: right;padding:4px;"><?php echo number_format($amount, 2, '.', ','); ?></th>
        </tr>
