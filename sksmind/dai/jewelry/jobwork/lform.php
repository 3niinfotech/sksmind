...
<input type="hidden" name="fn" value="sendToExport" />
<input type="hidden" name="type" value="lab" />
<input type="hidden" name="status" value="on_lab" />
...
<div class="col-xs-12 col-sm-12 ">		
	...
	<div class="form-group col-sm-3">
		<label class="col-sm-4 control-label no-padding-right" for="form-field-4">Place @</label>
		<div class="col-sm-8">
