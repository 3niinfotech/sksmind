				...
				<div class="main-content-inner">					
					<div class="page-content">
						<div class="page-header">
							...
							<button class="btn btn-info" type="button" onClick="location.href='<?php echo $daiUrl;?>jewelry/party'" style="float:right">
								<i class="ace-icon fa fa-reply bigger-110"></i>
								Back
							</button>
							<?php else: ?>
							<button class="btn btn-info" type="button" onClick="location.href='<?php echo $daiUrl;?>jewelry/party/index.php?pg=form'" style="float:right">
						...
						<?php
							...
							?>
							<?php 
							$groupUrl = $daiDir.'jewelry/party/';
							$modUrl = $daiUrl.'jewelry/party/';
		...
		<script type="text/javascript">
			...
			function loadparty(id)
			{
				...
				jQuery('#please-wait').show();
					var data = {'id':id};
					jQuery.ajax({
						url: '<?php echo $jewelryUrl.'party/partyDetail.php' ?>', 
						type: 'GET',
						data: data,		
