	...
	<body class="no-skin">
					...
					<div class="page-content">
						...
						<?php
							...
							<div class="form-group col-sm-6" style=" margin-bottom: 0; margin-top: 20px;">
								<label class="col-sm-4 control-label no-padding-right" for="form-field-4" style="color:#2679b5">Enter Side Stone Id / SKU :</label>
								<div class="col-sm-8">
		...
		<script type="text/javascript">
			...
			function loadHistory(sku)
			{
				...
				jQuery.ajax({
					url: '<?php echo $daiUrl.'jewelry/report/sideHData.php'; ?>', 
					type: 'POST',
					data: data,		
