	...
	<body class="no-skin">
				...
				<div class="main-content-inner">					
					<div class="page-content">
						...
						<!--	<div class="form-group col-sm-1" style="padding: 0px; margin-bottom: 5px; margin-right: 0px; width: 130px;">
							...
							<div class="form-group col-sm-2" style="padding:0px;margin-bottom: 5px;margin-right:20px;margin-left:20px;">
								<div class="col-sm-11">
									<select class="col-xs-12" name="party" onChange="loadMemo()">
							...
							<div class="form-group col-sm-2" style="padding:0px;margin-bottom: 5px;margin-right:20px;margin-left:20px;">
								<div class="col-sm-11">
									<select class="col-xs-12" name="type" onChange="loadMemo()">
						...
						<!--	<div class="inventory-color">
							...
							<div class="col-sm-12"><input class="input-sm col-sm-12" style="margin-right:2%;"  value="" onChange="loadMemo()" name="invoice" placeholder="Invoice No" type="text"></div></div>-->								
							<div class="form-group col-sm-1" style="padding: 0px; margin-bottom: 5px; margin-right: 0px; width: 11%;">				
								<div class="col-sm-12">
		...
		<script type="text/javascript">
			...
			function loadMemo()
			{
				...
				jQuery.ajax({
					url: '<?php echo $daiUrl.'jewelry/report/mgrid.php'; ?>', 
					type: 'POST',
					data: data,		
			...
			function loadRecord(type,id)
			{
				...
				jQuery.ajax({
					url: '<?php echo $daiUrl.'jewelry/report/mrgrid.php'; ?>', 
					type: 'POST',
					data: data,		
					success: function(result)
						{		
