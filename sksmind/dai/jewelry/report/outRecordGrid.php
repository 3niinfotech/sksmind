...
<form class="form-horizontal" id="saveLess" method="POST" role="form" enctype="multipart/form-data" action="<?php echo $daiUrl.'account/expense/expenseController.php'?>">
    ...
    <div class="col-xs-12 col-sm-12 " style="">
        ...
        <div class="col-sm-2 center">
            <button class="btn btn-info" type="button" onClick="saveCharge('<?php echo $_POST['type'] ?>',<?php echo $_POST['eid'] ?>)"> <i class="ace-icon fa fa-check bigger-110"></i> Save Charge </button>
        </div>
    </div>
</form>
<div style="clear:both"></div>
	...
	<form class="form-horizontal" id="savePart" method="POST" role="form" enctype="multipart/form-data" action="<?php echo $daiUrl.'account/expense/expenseController.php'?>">
		...
		<div class="col-xs-12 col-sm-12 " style="">
			...
			<div class="form-group col-sm-6">
				...
				<?php else: ?>
				<input class="input-sm col-sm-12" id="description" name="description" placeholder="Enter Description" type="text" value="<?php if($data['paid_amount'] == 0):echo ''; else: echo " Part ";endif; ?> Payment paid of Invoice No:<?php echo $data['invoiceno'] ?> ">
				<?php endif; ?>
				</div>
			</div>
			<div class="col-md-6">
				<button class="btn btn-info" type="button" onClick="savePart('<?php echo $_POST['type'] ?>',<?php echo $_POST['eid'] ?>)"> <i class="ace-icon fa fa-check bigger-110"></i> Save Installment </button> &nbsp; &nbsp; &nbsp;
