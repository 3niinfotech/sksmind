	...
	<body class="no-skin">
				...
				<div class="main-content-inner">					
					<div class="page-content">
						...
						<?php
							...
							<input type="hidden" value="reportExportJew" name="fn">
								...
								<div class="col-sm-12">
									<select class="col-xs-12" name="report" onChange="loadMemo()">
										...
										<option value="sale">Sale</option>
											<!--<option value="close_memo">Close Memo</option>					<option value="close_sale">Close Sale</option>	-->						
									</select>
								</div>
							</div>
							...
							<div class="form-group col-sm-2" style="padding:0px;margin-bottom: 5px;margin-left:15px;margin-right: 15px;">
								<div class="col-sm-12">
							...
							<div class="form-group col-sm-1" style="padding: 0px; margin-bottom: 5px; margin-right: 0px; width: 11%;">												<div class="col-sm-12">									<input class="input-sm col-sm-12" style="margin-right:2%;"  value="" onChange="loadMemo()" name="invoice" placeholder="Invoice No" type="text">			</div>	
							</div>							
		...
		<script type="text/javascript">
			...
			function loadMemo()
			{
				...
				jQuery.ajax({
					url: '<?php echo $daiUrl.'jewelry/report/jewmgrid.php'; ?>', 
					type: 'POST',
					data: data,		
			...
			function loadRecord(id)
			{
				...
				jQuery.ajax({
					url: '<?php echo $daiUrl.'jewelry/report/jewmrgrid.php'; ?>', 
					type: 'POST',
					data: data,		
					success: function(result)
						{		
