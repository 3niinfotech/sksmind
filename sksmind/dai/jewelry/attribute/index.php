...
<?php include($daiDir."head.php"); ?>	
				...
				<div class="main-content-inner">					
					<div class="page-content">
						<div class="page-header">
							<h1 style="float:left">
								Manage Jewelry Attributes								
							</h1>
							<?php if(isset($_GET['pg']) && $_GET['pg'] == "form"): ?>
							
							<button class="btn btn-info" type="button" onClick="location.href='<?php echo $daiUrl;?>jewelry/attribute'" style="float:right">
								<i class="ace-icon fa fa-reply bigger-110"></i>
								Back
							</button>
							<?php else: ?>
							<button class="btn btn-info" type="button" onClick="location.href='<?php echo $daiUrl;?>jewelry/attribute/index.php?pg=form'" style="float:right">
						...
						<?php
							...
							?>
							<?php 
							$groupUrl = $daiDir.'jewelry/attribute/';
							$modUrl = $daiUrl.'jewelry/attribute/';
	...
	<!-- basic scripts -->
		...
		<script type="text/javascript">
			...
			function removeEntry(url,party)
			{
					bootbox.confirm("Are you sure you want to delete?<br/><b>Name</b> : "+party, function(result) {
					if(result) 
					{
