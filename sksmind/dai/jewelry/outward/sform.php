...
?>
	...
	<input type="hidden" name="fn" value="updateOutward" />
...
<div class="col-xs-12 col-sm-12 ">
	...
	<div class="form-group col-sm-3">
		<label class="col-sm-4 control-label no-padding-right" for="form-field-4">Sale @</label>
		<div class="col-sm-8">
	...
	<div class="form-group col-sm-3">
		...
		<div class="col-sm-8">
			<input class="input-sm col-sm-10" id="edate" value="<?php echo $data['date']?>" name="date" placeholder="Select Date" type="text">
		</div>
	</div>
	<div class="form-group col-sm-3">
	...
	<div class="form-group col-sm-3">
		...
		<div class="col-sm-8">
			<input class="input-sm col-sm-10" id="invoiceno" readonly value="<?php echo $data['invoiceno']?>" name="invoiceno" placeholder="INC201608" type="text">
		</div>
	</div>
	<div class="form-group col-sm-3">
		<label class="col-sm-4 control-label no-padding-right" for="form-field-4">Invoice Date</label>
		<div class="col-sm-8">
			<input class="input-sm col-sm-10" onChange="calEditDue()" id="einvoicedate" value="<?php echo $data['invoicedate']?>" name="invoicedate" placeholder="2016/08/20" type="text">
		</div>
	</div>
	<div class="form-group col-sm-3">
		<label class="col-sm-4 control-label no-padding-right" for="form-field-4">Terms</label>
		<div class="col-sm-8">
			<input class="input-sm col-sm-10" onChange="calEditDue()" id="eterms" value="<?php echo ($data['terms']!='')?$data['terms']:''; ?>" name="terms" placeholder="Your Terms" type="text">
		</div>
	</div>
	<div class="form-group col-sm-3">
		<label class="col-sm-4 control-label no-padding-right" for="form-field-4">Due Date</label>
		<div class="col-sm-8">
			<input class="input-sm col-sm-10" id="eduedate" value="<?php echo ($data['terms']!='')?$data['duedate']:$data['invoicedate']?>" name="duedate" placeholder="2016/09/02" type="text">
		</div>
	</div>
	...
	<div class="form-group col-sm-3">
		...
		<div class="col-sm-7">
			<input class="input-sm col-sm-12" id="paid_amount"  name="paid_amount" value="<?php echo $data['paid_amount']?>"  type="text">
		</div>
	</div>
	<div class="form-group col-sm-3">
...
<?php include('subform/sgrid.php'); ?>

<?php if($data['type'] == 'export' || $data['type'] == 'consign'): ?>
<div style="clear:both"></div>
<br>
...
<div class="col-xs-12 col-sm-12 " <?php if($data['type'] == 'export'): ?>style="margin-top:0px" <?php else:?>style="margin-top:20px"<?php endif;?>>
...
<div class="clearfix form-actions" >
	<div class="col-md-12">
		...
		<button id="close-box" onclick="closeBox1()"  class="btn btn-danger" type="button">
