<form class="form-horizontal" method="POST" role="form" enctype="multipart/form-data" action="<?php echo $moduleUrl.'outward/outwardController.php'?>">
...
<div class="col-xs-12 col-sm-12 ">
	...
	<div class="form-group col-sm-3">
		<label class="col-sm-4 control-label no-padding-right" for="form-field-4">Paid Amount</label>
		<div class="col-sm-8">
			<input class="input-sm col-sm-10" id="paid_amount"  name="paid_amount" value="<?php echo $data['paid_amount']?>" placeholder="#2016/08/45" type="text">
		</div>
	</div>
	<div class="form-group col-sm-3">
		<label class="col-sm-4 control-label no-padding-right" for="form-field-4">Due Amount</label>
		<div class="col-sm-8">
			<input class="input-sm col-sm-10" id="due_amount"  name="due_amount" value="<?php echo $data['due_amount']?>" placeholder="#2016/08/45" type="text">
		</div>
	</div>
