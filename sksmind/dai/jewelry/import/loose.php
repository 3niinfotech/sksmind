				...
				<div class="main-content-inner">					
					<div class="page-content">
						<div class="page-header">
							<?php  ?>
							<h1 style="float:left">
								Loose - <?php echo ucfirst($t) ?> Transaction								
							</h1>
							...
							<?php else: ?>
							<button class="btn btn-info" type="button" onClick="location.href='<?php echo $daiUrl;?>module/import/loose.php?pg=form'" style="float:right">
						...
						<?php
							...
							$attribute = $jhelper->getLooseImportAttribute();
							
							//$TempData = $jhelper->getTempData();
							$TempData = $jhelper->getlooseTempData();
							...
							{	
								...
								if($t=='import')
								{
								include($groupUrl."liform.php");								
								}
								else
								{
									include($groupUrl."lform.php");								
								}
							}	
							else
							{
			...
			jQuery(function($) {
				...
				*/
				...
				function addImportRow(rid)
				{
					...
					row += '<div class="divTableCell"><input class=" col-sm-12 a-right tni-amount"  name="record['+n+'][amount]" readonly id="amount-'+n+'" type="text"></div>';					
