...
<div class="divTable" style="width: 3500px;">
	...
	<div class="divTableHeading">
		...
		<?php /* <div class="divTableCell">Remarks </div> */	?>			 
	</div>		
	...
	<div class="divTableBody">		
		<div class="divTableRow">
			...
			<div class="divTableCell"><input class=" col-sm-12 a-right tni-amount" name="record[1][amount]" id="amount-1" type="text"></div>
			...
			<?php /* <div class="divTableCell"><input class=" col-sm-12"  name="record[1][remarks]" type="text"></div> */ ?>						
	...
	<?php else: ?>
		...
		<div class="divTableBody">
			...
			<div class="divTableRow">
				...
				<div class="divTableCell"><input class=" col-sm-12 a-right tni-amount"  name="record[<?php echo $i?>][amount]" value="<?php echo $jData['amount']?>" id="amount-<?php echo $i?>" type="text"></div>
