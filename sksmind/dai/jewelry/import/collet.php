				...
				<div class="main-content-inner">					
					<div class="page-content">
						<div class="page-header">
							<?php  ?>
							<h1 style="float:left">
								Collet - <?php echo ucfirst($t) ?> Transaction								
							</h1>
						...
						<?php
							...
							{	
								...
								if($t=='import')
								{
									include($groupUrl."ciform.php");								
								}
								else
								{
									include($groupUrl."cform.php");								
								}
							}	
							else
							{
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				*/
				...
				var option ='';
				<?php foreach($goldColor as $key => $value):	?>						
				option += '<option value="<?php echo $key?>" <?php echo ($key == '')?"selected":""; ?> ><?php echo $value?></option>';
				<?php endforeach; ?>
				var opt ='';
				<?php foreach($gold as $key => $value):	?>						
				opt += '<option value="<?php echo $key?>" <?php echo ($key == '')?"selected":""; ?> ><?php echo $value?></option>';
				<?php endforeach; ?>
				function addImportRow(rid)
				{
					...
					row += '<div class="divTableCell"><input class=" col-sm-12"  name="record['+n+'][color]" type="text"></div>';
					row += '<div class="divTableCell"><input class=" col-sm-12"  name="record['+n+'][color_code]" type="text"></div>';
					row += '<div class="divTableCell"><input class=" col-sm-12 a-right"  name="record['+n+'][clarity]" type="text"></div>';
					row += '<div class="divTableCell"><input class=" col-sm-12"  name="record['+n+'][shape]" type="text"></div>';
					...
					row += '<div class="divTableCell"><input class=" col-sm-12 a-right" onBlur="calCostAmount('+n+')" name="record['+n+'][cost]" id="cost-'+n+'" type="text"></div>';
					row += '<div class="divTableCell"><input class=" col-sm-12 a-right"  name="record['+n+'][cost_amount]" id="cost_amount-'+n+'" type="text"></div>';
					row += '<div class="divTableCell"><input class=" col-sm-12"  name="record['+n+'][report_no]" id="report_no-'+n+'" type="text"></div>';
					row += '<div class="divTableCell"><input class="col-sm-12"  name="record['+n+'][remarks]" type="text"></div>';
					row += '<div class="divTableCell"><select class="col-sm-12 skph" id="goldcolor-'+n+'" name="collet['+n+'][collet_color]">';
					row += '<option value="">Gold Color</option>';
					row += option+'</select></div>';
					row += '<div class="divTableCell"><select class="col-sm-12 skph" id="gold-'+n+'" name="collet['+n+'][collet_kt]" onBlur="calculateTotalAmountColl('+n+')" onChange="calculateTotalAmountColl('+n+')">';
					row += '<option value="">Gold Carat</option>';
					row += opt+'</select></div>';
					row += '<div class="divTableCell"><input class=" col-sm-12 a-right" id="gross_weight-'+n+'" onBlur="calculateTotalAmountColl('+n+')" onChange="calculateTotalAmountColl('+n+')" name="collet['+n+'][gross_weight]" placeholder="" type="text"></div>';
					row += '<div class="divTableCell"><input class=" col-sm-12 a-right"  id="net_weight-'+n+'" name="collet['+n+'][net_weight]" placeholder="" type="text"></div>';
					row += '<div class="divTableCell"><input class=" col-sm-12 a-right" id="pg_weight-'+n+'"  name="collet['+n+'][pg_weight]" placeholder="" type="text"></div>';
					row += '<div class="divTableCell"><input class=" col-sm-12 a-right" id="collet_rate-'+n+'" onBlur="calculateTotalAmountColl('+n+')" onChange="calculateTotalAmountColl('+n+')" name="collet['+n+'][collet_rate]" placeholder="" type="text"></div>';
					row += '<div class="divTableCell"><input class=" col-sm-12 a-right" id="collet_amount-'+n+'"  name="collet['+n+'][collet_amount]" placeholder="" type="text"></div>';
					row += '<div class="divTableCell"><input class=" col-sm-12 a-right" id="other_code-'+n+'"  name="collet['+n+'][other_code]" placeholder="" type="text"></div>';
					row += '<div class="divTableCell"><input class=" col-sm-12 a-right" id="other_amount-'+n+'" onBlur="calculateTotalAmountColl('+n+')" onChange="calculateTotalAmountColl('+n+')" name="collet['+n+'][other_amount]" placeholder="" type="text"></div>';
					row += '<div class="divTableCell"><input class=" col-sm-12 a-right" id="labour_rate-'+n+'"  onBlur="calculateTotalAmountColl('+n+')" onChange="calculateTotalAmountColl('+n+')" name="collet['+n+'][labour_rate]" placeholder="" type="text"></div>';
					row += '<div class="divTableCell"><input class=" col-sm-12 a-right" id="labour_amount-'+n+'"   name="collet['+n+'][labour_amount]" placeholder="" type="text"></div>';
					row += '<div class="divTableCell"><input class=" col-sm-12 a-right" name="collet['+n+'][percentage]" placeholder="" type="text"></div>';	
					row += '<div class="divTableCell"><input class=" col-sm-12 a-right" id="ftotal_amount-'+n+'"   name="collet['+n+'][total_amount]" placeholder="" type="text"></div>';	
					row += '<div class="divTableCell"><input class=" col-sm-12 a-right" name="collet['+n+'][total_amount_cost]" placeholder="" type="text"></div>';
				...
				function calCostAmount(rid)
				{
					var price = parseFloat($('#cost-'+rid).val());
					var pcarat = parseFloat($('#pcarat-'+rid).val());
					var total  = parseFloat(price * pcarat );
					
					if(!isNaN(total))
					{
						$("#cost_amount-"+rid ).val(total.toFixed(2));
					}
					else
					{
						$("#cost_amount-"+rid ).val(0);
					}
