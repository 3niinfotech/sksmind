	...
	<body class="no-skin">
			...
			<div class="main-content">
				<div class="main-content-inner">					
					<div class="page-content">
						...
						<div class="row">
						<?php
							include('mmakerModel.php');
							$model  = new mmakerModel($cn);
							?>
							<?php 
							$mmakerUrl = $daiUrl.'jewelry/mmaker/';
							
							$mmakerDir= $daiDir.'jewelry/mmaker/';
							include($mmakerDir."grid.php");
							include($mmakerDir."form.php");
							?>
						</div>
					</div><!-- /.page-content -->
				</div>
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				$.fn.dataTable.Buttons.defaults.dom.container.className = 'dt-buttons btn-overlap btn-mmaker btn-overlap';
				...
				myTable.button(1).action(function (e, dt, button, config) {
					...
					$('.dt-button-info').addClass('gritter-mmaker-wrapper gritter-info gritter-center white');
				});
			...
			{
				if (confirm('Are you sure you want to mmaker No.?')) {
					window.location = "<?php echo $mmakerUrl.'mmakerController.php?fn=delete&id='?>"+id;
				} else {
					return 0;
				}
			}	
