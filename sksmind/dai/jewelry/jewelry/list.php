...
<?php //include($daiDir."Process.php"); ?> 
		...
		function countCheck(temp)
			...
			function toRepair()
			{
				 ...
				 var checkValues = $('.invenotry-cgrid input[name=sku]:checked').map(function()
				{
					return $(this).val();
				}).get();
				...
				{	
					...
					jQuery.ajax({
						url: '<?php echo $jewelryUrl.'jewelry/toRepair.php' ?>', 
						type: 'POST',
						data: data,		
						success: function(result)
							{		
			...
			function loadGrid(data)
			{
					...
					jQuery.ajax({
						url: '<?php echo $jewelryUrl.'jewelry/listgrid.php?form_type=';?>'+ftype, 
						type: 'POST',
						data:data,	
						success: function(result)
							{		
			...
			function changePrice()
			{
				...
				{	
					...
					jQuery.ajax({
						url: '<?php echo $jewelryUrl.'jewelry/changePrice.php' ?>', 
						type: 'POST',
						data: data,		
						success: function(result)
							{		
			...
			function sendToLab()
			{
				...
				{	
					...
					jQuery.ajax({
						url: '<?php echo $jewelryUrl.'jewelry/jewLab.php' ?>', 
						type: 'POST',
						data: data,		
						success: function(result)
							{		
			...
			function sortForFilter(filter)
			{
				...
				function printSticker()
				{
					...
					if(checkValues.length)
					{	
						window.open('<?php echo $mainUrl.'pdf/file/print.php?id'?>=' + checkValues,'_blank');
					}
					else
					{
						alert('Please Select Item');
