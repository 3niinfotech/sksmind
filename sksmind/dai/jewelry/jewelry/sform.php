...
?>
	...
	<input type="hidden" name="fn" value="updateSale" />
...
<div class="col-xs-12 col-sm-12 ">
	...
	<div class="form-group col-sm-3">
		...
		<div class="col-sm-7">
			<input class="input-sm col-sm-12" id="paid_amount" readonly  name="paid_amount" value="<?php echo $data['paid_amount']?>"  type="text">
		</div>
	</div>
	<div class="form-group col-sm-3">
		<label class="col-sm-5 control-label no-padding-right" for="form-field-4">Due Amount</label>
		<div class="col-sm-7">
			<input class="input-sm col-sm-12" id="due_amount" readonly name="due_amount" value="<?php echo $data['due_amount']?>" placeholder="#2016/08/45" type="text">
		</div>
	</div>
