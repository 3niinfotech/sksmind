<form class="form-horizontal" id="edit-sale" method="POST" role="form" enctype="multipart/form-data" action="<?php echo $moduleUrl.'jewelry/jewelryController.php'?>">
...
<div class="clearfix form-actions" >
	<div class="col-md-12 gd" style="margin-top: 30px;">
		<div class="form-group col-sm-5">		
