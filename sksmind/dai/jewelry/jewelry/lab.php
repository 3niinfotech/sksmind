	...
	<body class="no-skin">
		...
		<script type="text/javascript">
			...
			function loadMemo()
			{
				...
				jQuery.ajax({
					url: '<?php echo $daiUrl.'jewelry/jewelry/glab.php'; ?>', 
					type: 'POST',
					data: data,		
			...
			function closeMemo(id)
			{
				...
				jQuery.ajax({
					url: '<?php echo $daiUrl.'module/jewelry/jewelryController.php'; ?>', 
					type: 'POST',
					data: data,		
					success: function(result)
						{		
			...
			function returnMemo(id)
			{
				...
				jQuery.ajax({
					url: '<?php echo $daiUrl.'jewelry/jewelry/labForm.php'; ?>', 
					type: 'POST',
					data: data,		
					success: function(result)
						{		
			...
			function editSale(id,lid)
			{
				...
				jQuery.ajax({
					url: '<?php echo $daiUrl.'jewelry/jewelry/editLab.php'; ?>', 
					type: 'POST',
					data: data,		
					success: function(result)
						{		
