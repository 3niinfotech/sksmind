	...
	<div class="subform invenotry-cgrid mform-<?php echo $k?>">
		<div class="divTable" style="width:700px">
			...
			<div class="outward divTableBody">
				...
				//$sprice = ($jData['sell_price'] ==0)?$jData['price']:$jData['sell_price'];
...
<div class="col-sm-5">
	<div class="cgrid-header green">
		...
		<div class="color-total"> <b>Net WT:</b>  <span class="blue" ><?php echo $memo['net_weight'] ?>&nbsp;&nbsp;&nbsp;&nbsp;</span> </div>
		<div class="color-total"> <b>Rate :</b>  <span class="blue" ><?php echo $memo['rate'] ?></span> </div><br><br>
