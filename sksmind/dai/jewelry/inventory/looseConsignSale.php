...
<div class="divTable" style="width:1338px;">
	...
	$i=1;
	$pcs = $carat = $price = $amount = $fprice = $famount = 0.0;
	...
	<div class="divTableRow infobox-grey infobox-dark">		
		...
		<div class="divTableCell a-right"><input name="crecord[<?php echo $id ?>][sell_amount]" class="col-sm-12 a-right  amount1" onChange="totalamount()" type="text" value="<?php echo $famount?>"></div>	
