...
<div class="divTable" >
	...
	$cproducts = array();
	if(isset($_POST['collet_stone']))
	$cproducts = $_POST['collet_stone'];
	foreach($cproducts  as $id): 
	 if($id == '')
		 continue;
	...
	$price = $price + $fprice;
	$famount = $value['sell_amount'];
	$amount = $amount + $famount;
	?>
	<input type="hidden" name="collet_stone[]" value="<?php echo $id ?>" />
	<div class="divTableRow infobox-grey infobox-dark">		
		...
		<div class="divTableCell amount1 a-right"><input name="crecord[<?php echo $id ?>][sell_amount]" class="col-sm-12 a-right  amount1" onChange="totalamount()" type="text" value="<?php echo $famount?>"></div>	
