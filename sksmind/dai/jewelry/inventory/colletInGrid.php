...
$inventory = $model->getMyColletInventory($post,$form_type);
...
<div class="inventory-container" style="padding:0px 0px;">
	<div class="inventory-color">
		...
		<button class="btn btn-danger" type="button" onclick="removeCollet()" style="float: right; margin: 0px; margin-right:10px;padding: 0px 8px;">
