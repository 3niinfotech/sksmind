	...
	<body class="no-skin">
		...
		<script type="text/javascript">
			...
			function loadMemo()
			{
				...
				jQuery.ajax({
					url: '<?php echo $daiUrl.'jewelry/inventory/colletMakingGrid.php'; ?>', 
					type: 'POST',
					data: data,		
		...
		/* 	function returnMemo(id)
			...
			function editSale(id,lid)
			{
				...
				jQuery.ajax({
					url: '<?php echo $daiUrl.'jewelry/inventory/colletWorkEdit.php'; ?>', 
					type: 'POST',
					data: data,		
					success: function(result)
						{		
			...
			function deleteSale(id,lid)
			{
				...
				if(result) 
				{
					var data = {'id':id,'lid':lid,'fn':'deleteColletMaking'};
					jQuery('#please-wait').show();
