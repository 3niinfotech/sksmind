...
<?php include($daiDir."head.php"); ?>	
	...
	<body class="no-skin">
					...
					<div class="page-content">
						...
						<?php
							...
							<div class="form-group col-sm-3">
								<label class="col-sm-2 control-label no-padding-right" for="form-field-4">Type</label>
								<div class="col-sm-8">
									<select class="col-xs-10" name="type" onChange="loadMemo()">
										<option value="">All</option>									
										<option value="0">In Making</option>									
							...
							<div class="form-group col-sm-3">
								<label class="col-sm-4 control-label no-padding-right" for="form-field-4">Entry no</label>
								<div class="col-sm-8">
									<input type="text" name="entryno" class="col-sm-12">
								</div>
							</div>
							</form>
						</div>
		...
		<script type="text/javascript">
			...
			function loadMemo()
			{
				var data = jQuery('#collet-form').serialize();
				jQuery('#please-wait').show();
				
				jQuery.ajax({
					url: '<?php echo $daiUrl.'jewelry/inventory/jewelryMakingGrid.php'; ?>', 
					type: 'POST',
					data: data,		
		...
		/* 	function returnMemo(id)
			...
			function returnMemo(id,pid)
			{
				...
				jQuery.ajax({
					url: '<?php echo $daiUrl.'jewelry/inventory/colletReturn.php'; ?>', 
					type: 'POST',
					data: data,		
					success: function(result)
						{		
			...
			function returnjewMemo(id,pid)
			{
				...
				jQuery.ajax({
					url: '<?php echo $daiUrl.'jewelry/inventory/jewelryReturn.php'; ?>', 
					type: 'POST',
					data: data,		
					success: function(result)
						{		
			...
			function editCollet(id,lid)
			{
				...
				jQuery.ajax({
					url: '<?php echo $daiUrl.'jewelry/inventory/colletWork.php'; ?>', 
					type: 'POST',
					data: data,		
					success: function(result)
						{		
			...
			function editColletReturn(id,lid)
			{
				 $("html, body").animate({ scrollTop: 0 }, 100);
				var data = {'id':id,'lid':lid,'return':1};
				jQuery('#please-wait').show();
			...
			function editJewelry(id,lid)
			{
				...
				jQuery.ajax({
					url: '<?php echo $daiUrl.'jewelry/inventory/jewelryWork.php'; ?>', 
					type: 'POST',
					data: data,		
					success: function(result)
						{		
			...
			function deleteJob(id,lid)
			{
				bootbox.confirm("Are you sure you want to delete ?", function(result) {
				if(result) 
				{
					var data = {'id':id,'lid':lid,'fn':'deleteJob'};
					jQuery('#please-wait').show();
...
.jewelryMaking .main-grid .divTableBody {
	height: 110px !important;
}
.jewelryMaking .cgrid-header {
	width: 100%;
}
</style>
</html>
