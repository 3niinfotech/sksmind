		...
		function mainCheck(temp)
			...
			/* function loadBox(id,t)
			{
				...
				jQuery('#please-wait').show();
					...
					jQuery.ajax({
						url: '<?php echo $jewelryUrl.'inventory/boxDetail.php' ?>', 
						type: 'GET',
						data: data,		
			...
			/* function tojobwork()
			{
				 var totalmain = $('.invenotry-cgrid input[name=mainstone]:checked').map(function()
				{
					return $(this).val();
				}).get();
				
				var totalside = $('.invenotry-cgrid input[name=sidestone]:checked').map(function()
				{
					return $(this).val();
				}).get();
				
				var data = {'main':totalmain,'side':totalside};
				
				
				if(totalmain.length || totalside.length )
				{	
					jQuery('#please-wait').show();
			...
			function loadGrid(data)
			{
					...
					jQuery.ajax({
						url: '<?php echo $jewelryUrl.'inventory/colletgrid.php' ?>',
						type: 'POST',
						data:data,	
						success: function(result)
							{		
			...
			{
				 var checkValues = $('.invenotry-cgrid input[name=mainstone]:checked').map(function()
				{
					return $(this).val();
				}).get();
				...
				{	
					...
					jQuery.ajax({
						url: '<?php echo $jewelryUrl.'inventory/lchangePrice.php' ?>', 
						type: 'POST',
						data: data,		
						success: function(result)
							{		
			...
			function loadAddPackage(rs)
			{
				...
				{	
					...
					jQuery.ajax({
						url: '<?php echo $jewelryUrl.'inventory/addtopackage.php' ?>', 
						type: 'POST',
						data: data,		
						success: function(result)
							{		
			...
			/* function mailForm()
			{
				...
				{	
					...
					jQuery.ajax({
						url: '<?php echo $jewelryUrl.'inventory/mailForm.php' ?>', 
						type: 'POST',
						data: data,		
						success: function(result)
							{		
