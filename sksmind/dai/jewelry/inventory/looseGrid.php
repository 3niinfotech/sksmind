...
$inventory = $model->getMyLooseInventory($post,$form_type);
...
<input type="hidden" name="fn" value="lexportToExcel">
...
<form id="grid-forms" class="form-horizontal" method="POST" role="form" enctype="multipart/form-data" action="<?php echo $daiUrl.'/jewelry/inventory/inventoryController.php'; ?>">
<input type="hidden" name="fn" value="lexportToExcel">
		...
		<div class="divTableBody" >
			...
			<div class="divTableRow <?php echo $class;?>">					
				...
				?>
					...
					<?php if($key =='sku' ): ?>
						<div class="divTableCell  $CalClass  <?php if(in_array($key,$right))echo 'a-right'; ?> "><?php //echo $id; ?> <a href="https://www.shreehk.com/rapnet.php?sku=<?php echo $sku ?>"  class="ni-color" target="_blank" title="View Videos and Photos " ><?php //echo $value['id'].' - ' ;?><?php echo $sku?></a></div>
					<?php else : ?>							
