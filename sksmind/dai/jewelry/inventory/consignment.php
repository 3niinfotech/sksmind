	...
	<body class="no-skin">
		...
		<script type="text/javascript">
			...
			function loadMemo(id)
			{
				...
				jQuery.ajax({
					url: '<?php echo $daiUrl.'jewelry/inventory/conggrid.php'; ?>', 
					type: 'POST',
					data: data,		
			...
			function returnMemo(id,pid)
			{
				...
				jQuery.ajax({
					url: '<?php echo $daiUrl.'jewelry/inventory/consignReturn.php'; ?>', 
					type: 'POST',
					data: data,		
					success: function(result)
						{		
			...
			function memoToSale(id,pid)
			{
				...
				jQuery.ajax({
					url: '<?php echo $daiUrl.'jewelry/inventory/consignToSale.php'; ?>', 
					type: 'POST',
					data: data,		
					success: function(result)
						{		
