...
$pid = $_POST['id'];
$data = $jhelper->getAllSale($pid,'sale');
//echo"<pre>";
//print_r($data);
//echo"</pre>";
if($pid =='')
		...
		<div class="divTable" style="width:1780px">
			...
			<div class="outward divTableBody">
				...
				<div class="divTableRow <?php echo $class;?>">					
					...
					<div class="divTableCell width-50px"><?php echo $jData['gold'] ?></div>			<div class="divTableCell"><?php echo $jData['gold_color'] ?></div>				
					...
					<div class="divTableCell"><?php echo $jData['total_amount'] ?></div>			<div class="divTableCell"><?php echo $jData['sell_price']?></div>		
				</div>
				<?php endforeach;?>
