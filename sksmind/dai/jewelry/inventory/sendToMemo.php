...
<div class="divTable" style="width:1338px;">
	...
	<?php 
	$i=1;
	$pcs = $carat = $price = $amount = $ca = $colletamount = 0.0;
	...
	$ca = ($value['total_amount_cost'] ==0)?$value['total_amount']:$value['total_amount_cost'];
	$colletamount = ($value['sell_amount'] ==0)?$ca:$value['sell_amount'];
	$amount = $amount + $colletamount;
	?>
	
	<div class="divTableRow infobox-grey infobox-dark">		
		<div class="divTableCell"><?php echo $i?></div>
		<div class="divTableCell"><?php echo "Collet"?></div>
		...
		<div class="divTableCell  a-right"><?php echo ($value['sell_price'] ==0)?$value['price']:$value['sell_price'] ?></div>	
		<div class="divTableCell a-right"><input name="crecord[<?php echo $id ?>][sell_amount]" class="col-sm-12 a-right  amount1" onChange="totalamount()" type="text" value="<?php echo $colletamount ?>"></div>
...
function totalamount()
{
	...
	$(".divTableRow .amount1" ).each(function( index ) 
	{
