	...
	<body class="no-skin">
							...
							<div class="form-group col-sm-3">
								...
								<div class="col-sm-8">
									<select class="col-xs-10" name="type" onChange="loadMemo()">
										...
										<option value="0">In Repairing</option>									
		...
		<script type="text/javascript">
			...
			function loadMemo()
			{
				...
				jQuery.ajax({
					url: '<?php echo $daiUrl.'jewelry/inventory/colletRepairingGrid.php'; ?>', 
					type: 'POST',
					data: data,		
		...
		/* 	function returnMemo(id)
			...
			function editSale(id,lid)
			{
				...
				jQuery.ajax({
					url: '<?php echo $daiUrl.'jewelry/inventory/colletRepairEdit.php'; ?>', 
					type: 'POST',
					data: data,		
					success: function(result)
						{		
			...
			function deleteRepair(id,lid)
			{
				bootbox.confirm("Are you sure you want to delete ?", function(result) {
				if(result) 
				{
					var data = {'id':id,'lid':lid,'fn':'deleteColletRepair'};
					jQuery('#please-wait').show();
...
.outward.divTableBody {height:55px; overflow-y:auto;}
.cgrid-header {
	width: 62%;
}
