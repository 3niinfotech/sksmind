...
<div class="form-group col-sm-2">		
	<div class="col-sm-12">
		<label class="col-sm-8 control-label no-padding-right" for="form-field-4">Cost Price</label>
	</div>
</div>
<div class="form-group col-sm-2">		
	<div class="col-sm-12">
...
<div class="form-group col-sm-2">		
	<div class="col-sm-12">
		<label class="col-sm-8 control-label no-padding-right" for="form-field-4">New Cost </label>
	</div>
</div>
<div class="form-group col-sm-2">		
	<div class="col-sm-12">
...
<div class="changeform">
	...
	<div class="form-group col-sm-2">		
		<div class="col-sm-12">
			<input class="input-sm col-sm-12" style="color:#000 !important" disabled value="<?php echo $value['mfg_code'].'-'.$value['diamond_no']?>" placeholder="Your Terms" type="text">
		</div>
	</div>
	<div class="form-group col-sm-2">		
		<div class="col-sm-12">
	...
	<div class="form-group col-sm-2">		
		<div class="col-sm-12">
			<input class="input-sm col-sm-12 oldcostprice" style="color:#000 !important"  disabled value="<?php echo $value['cost']?>"  type="text">
		</div>
	</div>
	<div class="form-group col-sm-2">		
		<div class="col-sm-12">
			<input class="input-sm col-sm-12 oldprice"  style="color:#000 !important" disabled value="<?php echo $value['price']?>"  type="text">
		</div>
	</div>
...
function mchangePrice()
{
	...
	var data =  $("#memo-form").serialize();
		...
		jQuery.ajax({
		url: '<?php echo $jewelryUrl.'import/inwardController.php'?>', 
		type: 'POST',
		data: data,		
