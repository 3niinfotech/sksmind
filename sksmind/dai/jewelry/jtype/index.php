	...
	<body class="no-skin">
				...
				<div class="main-content-inner">					
					<div class="page-content">
						<div class="page-header">
							<h1>
								Jewelry Type Management								
							</h1>
						</div><!-- /.page-header -->
						
						<div class="row">
						<?php
							include('jtypeModel.php');
							$model  = new jtypeModel($cn);
							?>
							<?php 
							$jtypeUrl = $daiUrl.'jewelry/jtype/';
							
							$jtypeDir= $daiDir.'jewelry/jtype/';
							include($jtypeDir."grid.php");
							include($jtypeDir."form.php");
							?>
						</div>
					</div><!-- /.page-content -->
				</div>
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				$.fn.dataTable.Buttons.defaults.dom.container.className = 'dt-buttons btn-overlap btn-jtype btn-overlap';
				...
				myTable.button(1).action(function (e, dt, button, config) {
					...
					$('.dt-button-info').addClass('gritter-jtype-wrapper gritter-info gritter-center white');
				});
			...
			{
				if (confirm('Are you sure you want to jtype No.?')) {
					window.location = "<?php echo $jtypeUrl.'jtypeController.php?fn=delete&id='?>"+id;
				} else {
					return 0;
				}
			}	
