...
<?php include($daiDir."head.php"); ?>	
	...
	<body class="no-skin">
			...
			<div class="main-content">
				<div class="main-content-inner">					
					<div class="page-content">
						...
						<div class="row">
						<?php
							include('clarityModel.php');
							$model  = new clarityModel($cn);
							?>
							<?php 
							$designUrl = $daiUrl.'jewelry/clarity/';
							
							$designDir= $daiDir.'jewelry/clarity/';
		...
		<script type="text/javascript">
			...
			{
				if (confirm('Are you sure you want to Delete Clarity No.?')) {
					window.location = "<?php echo $designUrl.'clarityController.php?fn=delete&id='?>"+id;
				} else {
					return 0;
				}
			}	
