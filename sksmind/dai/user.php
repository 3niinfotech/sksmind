						...
						?>
						 ...
						 <li class="collection-item avatar">
						   <i class="material-icons circle red">perm_identity</i>
							...
							<p><?php echo $company_list['firstname']; ?> <?php echo $company_list['lastname']; ?><br>
							  <?php echo $company_list['e_mail']; ?><br>
							  <?php echo $company_list['mobile']; ?>
							</p>
							<a href="<?php echo $mainUrl."newUser.php?id=". $company_list['id']; ?>" class="secondary-content"><i class="material-icons">mode_edit</i></a>
						  </li>
