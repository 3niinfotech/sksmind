				...
				<div class="main-content-inner">					
					<div class="page-content">
						<div class="page-header">
							...
							<button class="btn btn-info" type="button" onClick="location.href='<?php echo $daiUrl;?>module/party'" style="float:right">
								<i class="ace-icon fa fa-reply bigger-110"></i>
								Back
							</button>
							<?php else: ?>
							<button class="btn btn-info" type="button" onClick="location.href='<?php echo $daiUrl;?>module/party/index.php?pg=form'" style="float:right">
						...
						<?php
							...
							?>
							<?php 
							$groupUrl = $daiDir.'module/party/';
							$modUrl = $daiUrl.'module/party/';
