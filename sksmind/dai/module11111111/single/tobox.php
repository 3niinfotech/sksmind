...
$flag = (in_array('all',$userResource) || in_array('single',$userResource))  && in_array($_SESSION['companyId'],$companyResource);
					...
					<div class="page-content">
						<div class="page-header">							
							...
							<form id="formmixing" style="float:right">
								<input type="text" onChange="loadGrid(this.value)" name="sku" value= "<?php echo  $sku; ?>" placeholder="SKU" >
							</form>	
						...
						<?php
							...
							include_once($groupUrl."tbgrid.php");
		...
		<script type="text/javascript">
			...
			$('.box-form  textarea').attr("disabled",true);
			 ...
			 $(id+' textarea').attr("disabled",false);
			  ...
			  if(v == "existing")
			  {
				  jQuery('#btn-lable').html('Add to Box');
			  }
			  else
			  {
				  jQuery('#btn-lable').html('Create Box');
			  }
