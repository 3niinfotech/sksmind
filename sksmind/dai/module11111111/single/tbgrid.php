...
<div class="inventory-container" style="padding:10px;">
	<div class="inventory-color">
		<div class="inventory-color-cell" style="width:100%;padding-bottom:0px">		
			...
			<div class="color-total color-total-count"> <b>Pcs :</b> &nbsp;&nbsp;<span id="total-pcs">0</span> &nbsp;&nbsp; |</div>
			<div class="color-total color-total-count"> <b>Carats :</b> &nbsp;&nbsp;<span id="total-carat">0</span> &nbsp;&nbsp; |</div>			
			<div class="color-total color-total-count"> <b>Amount :</b> &nbsp;&nbsp;<span id="total-amount">0</span> &nbsp;&nbsp; |</div>
			...
			<button id="addToBox" disabled class="btn btn-info" style="float:right" type="button">
...
<div class="inventory-container">
	...
	<div class="inventory-total" >
		<div class="int-lable">Avg. Price :<span class="int-total"> <?php echo ($tcarat != 0)?number_format(((float)$tprice/(float)$tcarat ),2,",",""):'0';  ?> </span>
		</div>
	</div>
	<div class="inventory-total" >
		...
		<div class="control-group">
			...
			<div class="radio col-sm-6">
				<label>
					...
					<span class="lbl bigger-120"> Use Existing Box</span>
				</label>
			</div>
			...
			<div class="radio col-sm-6">
				<label>
					...
					<span class="lbl bigger-120"> Create New Box</span>
				</label>
			</div>
				...
				<div class="form-group col-sm-6">
					...
					<div class="col-sm-8">
						<select class="col-xs-12" id="boxcode" name="boxcode" onChange="getBoxDetail(this.value)">
							...
							<?php foreach($helper->getProfuctGroup('box')  as $key=>$value):?>
			...
			<div id="box-new" class="box-form no-display">
				<div class="form-group col-sm-6">
					<label class="col-sm-4 control-label no-padding-right" for="form-field-4">Box Mfg</label>
					<div class="col-sm-8">
						<input class="input-sm col-sm-12" id="terms" value="" name="newbox" placeholder="New Box Mfg" type="text">
					</div>
				</div>
				<div class="form-group col-sm-6">
					<label class="col-sm-4 control-label no-padding-right" for="form-field-4">Box Sku</label>
					<div class="col-sm-8">
						<input class="input-sm col-sm-12" id="sku" value="" name="sku" placeholder="New Box Sku" type="text">
					</div>
				</div>
			...
			<div class="col-md-12" style="text-align: center; margin-top: 20px;">
				...
				<button class="btn btn-info" type="submit">
					...
					<span id="btn-lable">Add to Box</span>
				</button>

				&nbsp; &nbsp; &nbsp;
				<button id="close-box" class="btn btn-danger" type="button">
