	...
	<body class="no-skin">
		...
		<script type="text/javascript">
			...
			function loadMemo(id)
			{
				...
				jQuery.ajax({
					url: '<?php echo $daiUrl.'module/inventory/inmgrid.php'; ?>', 
					type: 'POST',
					data: data,		
			...
			{
				var total = parseFloat($('.mform-'+id+' .divTableBody').find("input[type='checkbox']:checked").length);
					if(total > 0)
					{
			...
			function editSale(id,lid)
			{
				...
				jQuery.ajax({
					url: '<?php echo $daiUrl.'module/inward/purchase.php'; ?>', 
					type: 'POST',
					data: data,		
					success: function(result)
						{		
			...
			function memoToSale(id,pid)
			{
				...
				jQuery.ajax({
					url: '<?php echo $daiUrl.'module/inventory/memoToPurchase.php'; ?>', 
					type: 'POST',
					data: data,		
					success: function(result)
						{		
