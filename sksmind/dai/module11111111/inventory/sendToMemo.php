...
<div class="divTable" >
	...
	<div class="divTableHeading">
		...
		<div class="divTableCell width-70px">Rapnet</div>	
		<div class="divTableCell width-70px">Discount</div>			
	...
	<div class="divTableRow infobox-grey infobox-dark">		
		...
		<?php 
			...
			$rapData = $helper->RapnetPrice($value['shape'],$rcolor,$value['clarity'],$value['polish_carat'],$sprice); ?>
		...
		<?php if( !isset($_POST['id'])  && ( $value['group_type'] == 'box' || $value['group_type']=="parcel" ) ) :?>
				...
				<div class="divTableCell a-right width-70px " style="padding:0px"><?php echo $rapData['price'];?></div>
				<div class="divTableCell a-right width-70px " style="padding:0px"> <input style="width: 100%; height: 100%; border: 0px none; text-align: right;" type="text" value="<?php echo $rapData['discount'];?>" onBlur="calculateRapnetPrice(this.value,<?php echo $value['id'] ?>,<?php echo $rapData['price'];?>)"></div>				
		...
		<?php else: ?>
				...
				<div class="divTableCell a-right width-70px " style="padding:0px"><?php echo $rapData['price'];?></div>
				<div class="divTableCell a-right width-70px " style="padding:0px"> <input style="width: 100%; height: 100%; border: 0px none; text-align: right;" type="text" value="<?php echo $rapData['discount'];?>" onBlur="calculateRapnetPrice(this.value,<?php echo $value['id'] ?>,<?php echo $rapData['price'];?>)"></div>
				<div class="divTableCell a-right width-70px price" style="padding:0px"> <input style="width: 100%; height: 100%; border: 0px none; text-align: right;" type="text" id="price-<?php echo $value['id'] ?>" value="<?php echo $sprice?>" onBlur="changeTextPrice(this.value,<?php echo $value['id'] ?>)"></div>
	...
	<?php /*if( !isset($_POST['id'])  && ( $value['group_type'] == 'box' || $value['group_type']=="parcel" ) ) :?>
		<div class="divTableBody">		
			<div class="divTableRow">
				...
				<div class="divTableCell"><input class=" col-sm-12"  name="record[<?php echo $id ?>][mfg_code]" id="mfg-1"  type="text" ></div>			
				<div class="divTableCell"><input class=" col-sm-12"  name="record[<?php echo $id ?>][diamond_no]" id="mfg-1"  type="text" ></div>			
				<div class="divTableCell"><input class=" col-sm-12"  name="record[<?php echo $id ?>][sku]" id="sku-1" type="text"></div>
				<div class="divTableCell width-50px "><input class=" col-sm-12  a-right"  name="record[<?php echo $id ?>][rought_pcs]" type="text"></div>
				<div class="divTableCell width-50px"><input class=" col-sm-12 a-right"  name="record[<?php echo $id ?>][rought_carat]" type="text"></div>
				<div class="divTableCell width-50px"><input class=" col-sm-12  a-right"  name="record[<?php echo $id ?>][polish_pcs]" type="text"></div>
				<div class="divTableCell width-50px"><input class=" col-sm-12 a-right"  name="record[<?php echo $id ?>][polish_carat]" id="pcarat-<?php echo $id ?>" type="text"></div>
				<div class="divTableCell width-70px"><input class=" col-sm-12 a-right"  name="record[<?php echo $id ?>][cost]" type="text"></div>
				<div class="divTableCell width-70px"><input class=" col-sm-12 a-right"  name="record[<?php echo $id ?>][price]" id="price-<?php echo $id ?>" onBlur="calAmount(<?php echo $id ?>)"  type="text"> <input name="record[<?php echo $id ?>][amount]" id="amount1-<?php echo $id ?>" type="hidden"></div>
				<div class="divTableCell width-70px amount1 a-right" id="amount2-<?php echo $id ?>"></div>
				<div class="divTableCell width-50px"><input class=" col-sm-12 "  name="record[<?php echo $id ?>][location]" type="text"></div>
				<div class="divTableCell "><input class=" col-sm-12 "  name="record[<?php echo $id ?>][remark]" type="text"></div>
				<div class="divTableCell width-50px"><input class=" col-sm-12 "  name="record[<?php echo $id ?>][lab]" type="text"></div> 
				<?php 
				foreach($attribute as $key=>$v): ?>
				<div class="divTableCell <?php if(in_array($key,$width50))echo 'width-50px'; ?> ">		
						<input class=" col-sm-12"  name="record[<?php echo $id ?>][attr][<?php echo $key?>]" type="text">
				</div>
				<?php endforeach;?>
			</div>					
		</div>
