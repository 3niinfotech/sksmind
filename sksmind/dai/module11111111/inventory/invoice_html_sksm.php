    ...
    <table cellspacing="0" style="width: 100%; text-align: center; font-size: 14px">
        <tr>
            ...
            <td style="width: 30%; color: #444444;">
                <img style="width: 100%;" src="logo.gif" alt="Logo"><br>
			...
			<td style="width: 30%;text-align:left;">
				...
				<p style="  font-size: 13px;margin: 0 0 2px;">Web:www.shreeintl.com</p>
				<p style="  font-size: 13px;margin: 0 0 2px;">Skype ID:shreeintl.hk</p>
				<p style="  font-size: 13px;margin: 0 0 2px;">Rapnet ID:sksm105224</p>
            </td>
        </tr>
...
<?php
	...
	?>
		<tr>
            ...
            <td style="width: 43%; text-align: left;padding:4px;font-size:11px;"><?php echo $record[$i]['shape'].' '.$color.' '.$record[$i]['clarity'].' '.$record[$i]['size']; echo ($record[$i]['report_no'] != '')?' GIA : '.$record[$i]['report_no']:''; ?></td>
...
?>
    ...
    <table cellspacing="0" border="1" cellpadding="5" style="border-collapse:collapse;width: 100%; border: solid 1px black; color: #4991b1; text-align: center; font-size: 10pt;">
        <tr>
            ...
            <th style="width: 6%; text-align: right;padding:4px;"><?php echo number_format($pcs, 2, '.', ','); ?></th>
           ...
           <td style="width: 50%;text-align:left;;">
				...
				<table style="width: 100%;">
					<tr >
						...
						<td style="width:75%;">S.K.S.M (HK) LIMITED</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td style="width:75%;">470544996 (USD)<br/>
						</td>
					</tr>
					<tr>
       ...
       <table cellspacing="0" style="width: 100%; text-align: left; font-size: 14px">
        <tr>
		   ...
		   <td style="width: 35%;text-align: right;">				
				<p style="margin: 0 0 2px;padding-bottom:40px;color:#cc3399">For <b>S.K.S M (HK) Ltd.</b></p>
				<hr style="width:100%;height:1px;">
