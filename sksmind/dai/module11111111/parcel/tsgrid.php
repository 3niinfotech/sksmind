		...
		<div class="divTable" >
			...
			<div class="outward divTableBody">
				...
				<div class="outward divTableRow">					
					...
					<div class="divTableCell" style="text-align:left !important;" > 
					<?php 
						$id = $jData['id'];
						if(strtoupper($jData['group_type']) =='PARCEL' && $jData['box_products'] !="" )
						{	
							 echo '<a style="cursor:pointer; text-align:left !important;" onClick="loadBox('.$id.',1)" >  <i class="ace-icon fa  orange fa-codepen bigger-110"></i> '.$sku .'</a>'; 
						}				 
						else
						{
