...
$helper  = new Helper();
$data = $helper ->getDetailBySku($_POST['sku']);

$action = $helper->getStoneAction();
$pmodel  = new partyModel();
$party = $pmodel->getOptionList();
if(!empty($data)):
$history = $helper->getHistoryOfStone($data['id']);
$party['']="";
...
<div class="col-xs-12 col-sm-12 " >
	<?php foreach($helper->getInventoryAttribute() as $k=>$v) :
