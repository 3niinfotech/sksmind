...
$flag = (in_array('all',$userResource) || in_array('advance',$userResource))  && in_array($_SESSION['companyId'],$companyResource);
				...
				<div class="main-content-inner">					
					<div class="page-content">
						<div class="page-header">
							...
							<button class="btn btn-info" type="button" onClick="location.href='<?php echo $daiUrl;?>account/advance/index.php'" style="float:right;margin-left:20px;">
								<i class="ace-icon fa fa-reply bigger-110"></i>
								Data
							</button>
							
							<button class="btn btn-info" type="button" onClick="location.href='<?php echo $daiUrl;?>account/advance/index.php?pg=form'" style="float:right">
						...
						<?php
							...
							$groupUrl = $daiDir.'account/advance/';
							...
							{	
								...
								$invoice = $helper->getAllInvoiceOfParty($data['party']);								
...
<div class="dialog-box-container1" id="dialog-box-container1" style="display:none;" >
		...
		<script type="text/javascript">
			...
			{
				var data = {'id':id,'fn':'getInvoiceData'};
				jQuery.ajax({
				url: '<?php echo $daiUrl.'account/advance/advanceController.php'?>', 
				type: 'POST',
				data: data,		
				success: function(result)
				{		
					jQuery('#invoice-data').show();					
					var obj = jQuery.parseJSON(result);
					
					jQuery('#paid_amount').html(obj.paid_amount);
					jQuery('#due_amount').html(obj.due_amount);
