...
<div class="col-xs-12 col-sm-12 " >
	...
	<div class="form-group col-sm-6">
		...
		<div class="col-sm-8">
			<input tabindex="3"  class="input-sm col-sm-10" id="name" name="name" value="<?php echo $data['name']  ?>"  placeholder="Party Name"  type="text">
		</div>
	</div>
...
function SaveParty()
{
	...
	jQuery.ajax({
	url: '<?php echo $daiUrl.'account/party/partyController.php'?>', 
	type: 'POST',
	data: data,		
...
function partyOption()
{
	...
	var data = {'id':1};
	jQuery.ajax({
	url: '<?php echo $daiUrl.'account/party/partyOption.php'?>', 
	type: 'POST',
	data: data,		
	success: function(result)
	{		
