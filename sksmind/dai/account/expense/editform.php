...
<div class="col-xs-12 col-sm-5 " style="margin-left:2%; border:1px solid #ccc;">
...
<form class="form-horizontal" method="POST" role="form" enctype="multipart/form-data" action="<?php echo $daiUrl.'account/expense/expenseController.php'?>">
<input type="hidden" name="fn" value="changeBook" />
...
<?php } ?>
	...
	<div class="col-xs-12 col-sm-12 " style="border:1px solid #ccc;" >
	<br>
	<div class="form-group col-sm-9">
		<label class="col-sm-4 control-label no-padding-right" for="form-field-4">Change Book Type</label>
		<div class="col-sm-8">
...
<form class="form-horizontal" method="POST" role="form" enctype="multipart/form-data" action="<?php echo $daiUrl.'account/expense/expenseController.php'?>">
<input type="hidden" name="fn" value="changeType" />
...
<?php } ?>
	...
	<br>
	<div class="form-group col-sm-7">
		<label class="col-sm-4 control-label no-padding-right" for="form-field-4">Change Type</label>
		<div class="col-sm-8">
