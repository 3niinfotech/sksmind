...
$flag = (in_array('all',$userResource) || in_array('group',$userResource))  && in_array($_SESSION['companyId'],$companyResource);
				...
				<div class="main-content-inner">					
					<div class="page-content">
						...
						<?php
							...
							$model  = new groupModel($cn);
							?>
							<?php 
							$groupUrl = $daiDir.'account/group/';
