...
<div class="col-xs-12 col-sm-5 right">
	<div class="widget-box">
		...
		<form class="form-horizontal" method="POST" role="form" action="<?php echo $daiUrl.'account/subgroup/subgroupController.php'?>">
		<div class="widget-body">
			<div class="widget-main">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
					<select class="col-xs-10" id="gunder" name="under">
						<option value=""></option>
						<?php 
