	...
	<div class="box-container" style="width:600px;">
		...
		<div class="control-group">
			...
			<div id="box-new" class="box-form no-display">
				<div class="form-group col-sm-6">
					<label class="col-sm-4 control-label no-padding-right" for="form-field-4">Parcel Mfg</label>
					<div class="col-sm-8">
						<input class="input-sm col-sm-12" id="terms" value="" name="newbox" placeholder="New Box Mfg" type="text">
					</div>
				</div>
				<div class="form-group col-sm-6">
					<label class="col-sm-4 control-label no-padding-right" for="form-field-4">Parcel Sku</label>
					<div class="col-sm-8">
			...
			<div class="col-md-12" style="text-align: center; margin-top: 20px;">
				...
				<button class="btn btn-info" type="submit">
					...
					<span id="btn-lable" >Add to Parcel</span>
				</button>
