...
<div class="inventory-container" style="padding:0px 0px;">
	<div class="inventory-color">
		...
		<button class="btn btn-success" type="button" style="float: right; margin: 0px;" onclick="document.location.href = '<?php echo $daiUrl.'module/inventory/' ?>'">
			<i class="ace-icon fa fa-refresh bigger-110"></i> Reset
		</button>
		
		<button class="btn btn-success" type="button" onclick="mailForm()" style="float: right; margin: 0px; margin-right:10px;" >
			<i class="ace-icon fa fa-send bigger-110"></i> Mail
		</button>
		...
		<button class="btn btn-info" type="button" onclick="Puthold(0)" style="float: right; margin: 0px; margin-right:10px;">			
			Un Hold
		</button>
		<button class="btn btn-info" type="button" onclick="Puthold(1)" style="float: right; margin: 0px; margin-right:10px;">			
			Hold
		</button>
	</div>
</div>
...
<div class="subform invenotry-cgrid main-grid">
	<div class="divTable " style="width:2750px;" >
			...
			<div class="divTableRow <?php echo $class;?>">					
				...
				?>
					...
					<?php elseif($key =='main_color' ): ?>
						<div class="divTableCell  $CalClass <?php if(array_key_exists($key,$CalClass))echo $CalClass[$key]; ?>" style="width:200px"><?php echo $rcolor?></div>
						
					<?php elseif($key =='sku' ): ?>
						<div class="divTableCell fixsku $CalClass <?php if(array_key_exists($key,$CalClass))echo $CalClass[$key]; ?> <?php if(in_array($key,$right))echo 'a-right'; ?> <?php if(in_array($key,$width50))echo 'a-right'; ?>  <?php if(in_array($key,$width50))echo 'width-50px'; ?> <?php if(in_array($key,$width70))echo 'width-70px'; ?> "><?php //echo $id; ?> <a href="https://www.shreehk.com/rapnet.php?sku=<?php echo $sku ?>"  class="ni-color" target="_blank" title="View Videos and Photos " ><?php //echo $value['id'].' - ' ;?><?php echo $sku?></a></div>
					...
					<?php /*elseif($key =='rap_price' ): ?>
						<div class="divTableCell  $CalClass <?php if(array_key_exists($key,$CalClass))echo $CalClass[$key]; ?> <?php if(in_array($key,$right))echo 'a-right'; ?> <?php if(in_array($key,$width50))echo 'a-right'; ?>  <?php if(in_array($key,$width50))echo 'width-50px'; ?> <?php if(in_array($key,$width70))echo 'width-70px'; ?> "><input style="width: 100%; height: 100%; border: 0px none;text-align:right" type="text" value="<?php echo $value[$key] ?>" onBlur="changeTextValue(this.value,<?php echo $value['id'] ?>,'price')"></div>
						
						
					<?php /*elseif($key =='remark' ): ?>
					<div class="divTableCell  $CalClass <?php if(array_key_exists($key,$CalClass))echo $CalClass[$key]; ?> <?php if(in_array($key,$right))echo 'a-right'; ?> <?php if(in_array($key,$width50))echo 'a-right'; ?>  <?php if(in_array($key,$width50))echo 'width-50px'; ?> <?php if(in_array($key,$width70))echo 'width-70px'; ?> "><?php echo $value['location']?></div>
...
<script>
	...
	jQuery('.subform.invenotry-cgrid').scroll(function(event) {
		...
		if(jQuery('.subform.invenotry-cgrid').scrollLeft() > 100)
		{
			...
			jQuery(".main-grid .divTable").attr('style','width:2750px;');
