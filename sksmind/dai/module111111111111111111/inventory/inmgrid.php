...
<div class="button-group">
	<div class="cgrid-header green">
		<div class="color-total"> <b><?php echo ucfirst($memo['inward_type']) ?> : </b> &nbsp;&nbsp;<?php echo $i; ?> (<?php echo $memo['entryno'] ?>) <span class="blue" ><b><?php echo isset($party[$memo['party']])?$party[$memo['party']]:''; ?></b></span>  &nbsp;&nbsp; |</div>
