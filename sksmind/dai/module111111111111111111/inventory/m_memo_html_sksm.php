    ...
    <table cellspacing="0" style="width: 100%; text-align: center; font-size: 14px">
        <tr>
			...
			<td style="width: 40%;text-align:center;">
				<span style="color:#4991b1;font-size:18px;" >Approval Memo</span>
            </td>
     ...
     <table cellspacing="0" style="width: 100%; ; text-align: left; font-size: 14px">
        <tr>
           <td style="width: 30%;text-align:left;">
				...
				<p style="margin: 0 0 2px;padding-bottom:10px;">For <b>S.K.S M (HK) Ltd.</b></p>
           </td>
...
<page style="font-size: 12pt">
	...
	?>
		<tr>
            <td style="width: 5%; text-align: center;padding:4px;"><?php echo $i; ?></td>
            <td style="width: 14%; text-align: left;padding:4px;"><?php echo $sku; ?></td>
            <td style="width: 43%; text-align: left;padding:4px;"><?php echo $record[$i]['shape'].' '.$record[$i]['color'].' '.$record[$i]['clarity'].' '.$record[$i]['size']; ?></td>
