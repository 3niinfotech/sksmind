	...
	<body class="no-skin">
								...
								<div class="col-sm-9">
									<select class="col-xs-12" id="ledger" name="party" onChange="loadMemo()">
										...
										<?php endforeach; ?>
													...
													<div class="form-group col-sm-1" style="padding: 0px; margin-bottom: 5px; margin-left: 10px; margin-right: 0px; width: 11%;">												<div class="col-sm-12">									<input class="input-sm col-sm-12" style="margin-right:2%;"  value="" onChange="loadMemo()" name="invoice" placeholder="Invoice No" type="text">								</div>							</div>
		...
		<script type="text/javascript">
			...
			function loadMemo()
			{
				...
				jQuery.ajax({
					url: '<?php echo $daiUrl.'module/report/outstandingGrid.php'; ?>', 
					type: 'POST',
					data: data,		
			...
			function saveCharge(type,id)			{				var data = jQuery('#saveLess').serialize();								jQuery('#please-wait').show();								jQuery.ajax({					url: '<?php echo $daiUrl.'module/outward/outwardController.php'; ?>', 					type: 'POST',					data: data,							success: function(result)						{									if(result != "")								{									jQuery('#please-wait').hide();									var obj = jQuery.parseJSON(result);									alert(obj.message);									if(obj.status)									{										loadRecord(type,id)									}								}						}				});			}
			function loadRecord(type,id)
			{
				...
				jQuery.ajax({
					url: '<?php echo $daiUrl.'module/report/outRecordGrid.php'; ?>', 
					type: 'POST',
					data: data,		
					success: function(result)
						{		
